...
import com.nyw.eMurals.event.LoadPhotoEvent;
import com.nyw.eMurals.present.PhotoPresenter;
import com.nyw.eMurals.service.PhotoLoadService;
import com.nyw.eMurals.ui.view.PhotoView;
import com.nyw.eMurals.utils.Constants;
import com.nyw.eMurals.utils.GlideUtils;
import com.nyw.eMurals.utils.SharePrefUtil;
...
public class PhotoesDetailFragment extends MvpBaseFragment<PhotoView,
    ...
    @BindView(R.id.tv_like) TextView mLike;
    ...
    public void putImage() {
        SharePrefUtil.putImage(getContext(),"image",mPhoto);
        //imageView.setImageBitmap(SharePrefUtil.getImage(getContext(),"image",imageView));
        Toast.makeText(getContext(), "您已经收藏成功", Toast.LENGTH_SHORT).show();
    }
